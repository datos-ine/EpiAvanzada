...
La regresión logística se utiliza cuando la variable dependiente es dicotómica o binaria (éxito-fracaso; Si-No). Las variables independientes pueden ser de cualquier tipo (dicotómicas, categóricas, o numéricas discretas o continuas). Consideremos un evento de salud que puede ocurrir o no (variable dependiente). Por ejemplo:
