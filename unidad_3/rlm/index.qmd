...
p_valor <- round(resettest(mod_multiple)$p.value, 3)
```


El *p*-valor es de `{r} p_valor` por lo que no podemos rechazar la hipótesis nula de linealidad.
