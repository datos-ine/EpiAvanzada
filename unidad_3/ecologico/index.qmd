...
En este capítulo abordaremos la covarianza y correlación a modo de introducción, para luego entender el modelo lineal general y los modelos de [**regresión lineal simple**](https://datos-ine.github.io/EpiAvanzada/unidad_3/rls/) y [**regresión lineal múltiple**](https://datos-ine.github.io/EpiAvanzada/unidad_3/rlm/), ampliamente usados en el análisis de los estudios ecológicos, aunque no exclusivos de ellos.
