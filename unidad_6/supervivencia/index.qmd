...
```{r}
#| echo: true  
KM$surv # devuelve las estimaciones de Kaplan-Meier a cada t_i
KM$time # {t_i}
KM$n.risk # {Y_i}
KM$n.event # {d_i}
KM$std.err #  error standard de las estimaciones de  K-M a {t_i}
KM$lower # estimaciones puntuales inferiores (alternativamente, $upper)
```
